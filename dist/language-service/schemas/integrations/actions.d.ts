 ...
 */
import { Area, Data, Entities, Floor, IncludeList, Integer, Label, LegacySyntax, SceneEntity, Template, TimePeriod } from "../types";
import { Condition } from "./conditions";
import { Trigger } from "./triggers";
export type Action = ChooseAction | DelayAction | DeviceAction | EventAction | IfAction | ParallelAction | RepeatAction | SceneAction | ServiceAction | SequenceAction | StopAction | WaitForTriggerAction | WaitTemplateAction | VariablesAction | Condition;
