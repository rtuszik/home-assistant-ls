 ...
 */
import { Data, Entities, InputDatetimeEntities, InputNumberEntity, Template, TimePeriod, ZoneEntity, Times, DeviceTrackerEntities, PersonEntities, ZoneEntities, SensorEntities, NumberEntity, SensorEntity, CalendarEntity, LegacySyntax } from "../types";
import { WebOSTvTrigger } from "./core/webostv";
export type Trigger = CalendarTrigger | ConversationTrigger | DeviceTrigger | EventTrigger | GeolocationTrigger | HomeAssistantTrigger | MqttTrigger | NumericStateTrigger | PersistentNotificationTrigger | StateTrigger | SunTrigger | TagTrigger | TemplateTrigger | TimeTrigger | TimePatternTrigger | WebhookTrigger | WebOSTvTrigger | ZoneTrigger;
type EventType = "automation_reloaded" | "automation_triggered" | "call_service" | "component_loaded" | "deconz_event" | "homeassistant_started" | "homeassistant_stop" | "logbook_entry" | "platform_discovered" | "scene_reloaded" | "service_executed" | "service_registered" | "service_removed" | "state_changed" | "tag_scanned" | "themes_updates" | "time_changed" | "user_added" | "user_removed" | "zha_event";
