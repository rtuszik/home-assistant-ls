 ...
 */
import { DeviceTrackerEntities, DynamicTemplate, Entities, IncludeList, InputDatetimeEntity, InputNumberEntity, Integer, NumberEntity, PersonEntities, SensorEntity, State, Template, Time, TimePeriod, ZoneEntities } from "../types";
export type Weekday = "mon" | "tue" | "wed" | "thu" | "fri" | "sat" | "sun";
export type Condition = AndCondition | AndShorthandCondition | DeviceCondition | DynamicTemplate | NotCondition | NotShorthandCondition | NumericStateCondition | OrCondition | OrShorthandCondition | ShorthandCondition | StateCondition | SunCondition | TemplateCondition | TimeCondition | TriggerCondition | ZoneCondition;
