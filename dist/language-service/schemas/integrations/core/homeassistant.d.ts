...
import { Currency, CountryTags, DeviceClasses, IncludeNamed, Integer, LanguageTags, TimeZone, UnitSystem } from "../../types";
export type Domain = "group";
export interface Schema {
    auth_mfa_modules?: any[] | IncludeNamed;
    auth_providers?: AuthProviders[] | IncludeNamed;
    /**
 ...
 */
type AuthProviders = HomeAssistantAuthProvider | TrustedNetworksAuthProvider | CommandLineAuthProvider | LegacyApiPasswordAuthProvider;
