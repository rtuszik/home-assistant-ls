 ...
 */
import { Area, Entities, Entity, Floor, Include, Label, LegacySyntax } from "../types";
export type Action = CallServiceAction | CustomAction | Include | MoreInfoAction | NavigateAction | NoneAction | PerformActionAction | ToggleAction | URLAction;
