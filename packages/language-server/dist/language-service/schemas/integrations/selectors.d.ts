 ...
 */
import { Domain, DeviceClasses, Entity, PositiveInteger, SupportedFeature, LegacySyntax } from "../types";
export type Selector = ActionSelector | AddonSelector | AreaSelector | AssistPipelineSelector | AttributeSelector | BackupLocationSelector | BooleanSelector | ColorRGBSelector | ColorTempSelector | ConditionSelector | ConfigEntrySelector | ConstantSelector | ConversationAgentSelector | CountrySelector | DateSelector | DateTimeSelector | DeviceSelector | DurationSelector | EntitySelector | FileSelector | FloorSelector | IconSelector | LabelSelector | LanguageSelector | LocationSelector | MediaSelector | NumberSelector | ObjectSelector | QRCodeSelector | SelectSelector | StateSelector | TargetSelector | TemplateSelector | TextSelector | ThemeSelector | TimeSelector | TriggerSelector;
