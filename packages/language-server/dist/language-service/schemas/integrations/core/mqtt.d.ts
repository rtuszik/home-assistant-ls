 ...
 */
import { ColorMode, Deprecated, DeviceClassesBinarySensor, DeviceClassesCover, DeviceClassesSensor, IncludeList, Integer, PositiveInteger, StateClassesSensor, Template } from "../../types";
...
interface Item {
     ...
     */
    light?: LightDefaultItem | LightJSONItem | LightTemplateItem | (LightDefaultItem | LightDefaultItem | LightTemplateItem)[] | IncludeList;
    /**
     ...
     */
    vacuum?: VacuumItem | VacuumLegacyItem[] | (VacuumItem | VacuumLegacyItem)[] | IncludeList;
}
interface BaseItem {
    /**
