 ...
 */
import { DeviceClassesBinarySensor, DeviceClassesCover, DeviceClassesSensor, DeviceClassesSwitch, Entity, EntityCategory, Integer, StateClassesSensor, Template } from "../../types";
/**
...
type ValueType = "1byte_signed" | "1byte_unsigned" | "2byte_float" | "2byte_signed" | "2byte_unsigned" | "4byte_float" | "4byte_signed" | "4byte_unsigned" | "8byte_signed" | "absolute_humidity" | "absolute_temperature" | "acceleration_angular" | "acceleration" | "activation_energy" | "active_energy_8byte" | "active_energy_kwh" | "active_energy" | "activity" | "air_flow" | "amplitude" | "angle_deg" | "angle_rad" | "angle" | "angular_frequency" | "angular_momentum" | "angular_velocity" | "apparant_energy_8byte" | "apparant_energy_kvah" | "apparant_energy" | "apparent_power" | "area" | "brightness" | "capacitance" | "charge_density_surface" | "charge_density_volume" | "color_temperature" | "common_temperature" | "compressibility" | "concentration_ugm3" | "conductance" | "counter_pulses" | "curr" | "current" | "decimal_factor" | "delta_time_100ms" | "delta_time_10ms" | "delta_time_hrs" | "delta_time_min" | "delta_time_ms" | "delta_time_sec" | "density" | "electric_charge" | "electric_current_density" | "electric_current" | "electric_dipole_moment" | "electric_displacement" | "electric_field_strength" | "electric_flux_density" | "electric_flux" | "electric_polarization" | "electric_potential_difference" | "electric_potential" | "electrical_conductivity" | "electromagnetic_moment" | "electromotive_force" | "energy" | "enthalpy" | "flow_rate_m3h" | "force" | "frequency" | "heat_quantity" | "heatcapacity" | "heatflowrate" | "humidity" | "illuminance" | "impedance" | "kelvin_per_percent" | "latin_1" | "length_m" | "length_mm" | "length" | "long_time_period_hrs" | "long_time_period_min" | "long_time_period_sec" | "light_quantity" | "long_delta_timesec" | "luminance" | "luminous_flux" | "luminous_intensity" | "magnetic_field_strength" | "magnetic_flux_density" | "magnetic_flux" | "magnetic_moment" | "magnetic_polarization" | "magnetization" | "magnetomotive_force" | "mass_flux" | "mass" | "mol" | "momentum" | "percent" | "percentU8" | "percentV16" | "percentV8" | "phaseangledeg" | "phaseanglerad" | "power_2byte" | "power_density" | "power" | "powerfactor" | "ppm" | "pressure_2byte" | "pressure" | "pulse_2byte_signed" | "pulse_2byte" | "pulse_4_ucount" | "pulse_4byte" | "pulse" | "rain_amount" | "reactance" | "reactive_energy_8byte" | "reactive_energy_kvarh" | "reactive_energy" | "resistance" | "resistivity" | "rotation_angle" | "scene_number" | "self_inductance" | "solid_angle" | "sound_intensity" | "speed" | "stress" | "string" | "surface_tension" | "tariff" | "temperature_a" | "temperature_difference_2byte" | "temperature_difference" | "temperature_f" | "temperature" | "thermal_capacity" | "thermal_conductivity" | "thermoelectric_power" | "time_1" | "time_2" | "time_period_100msec" | "time_period_10msec" | "time_period_hrs" | "time_period_min" | "time_period_msec" | "time_period_sec" | "time_seconds" | "torque" | "voltage" | "volume_flow" | "volume_flux" | "volume_liquid_litre" | "volume_m3" | "volume" | "weight" | "wind_speed_kmh" | "wind_speed_ms" | "work";
...
interface Climate {
     ...
     */
    controller_modes?: ("off" | "auto" | "heat" | "cool" | "fan_only" | "dehumidification")[];
    /**
     ...
     */
    default_controller_mode?: "off" | "auto" | "heat" | "cool" | "heat_cool" | "fan_only" | "dry";
    /**
     * The category of the entity.
     * https://www.home-assistant.io/integrations/knx#entity_category
     */
     ...
     */
    operation_modes?: ("auto" | "comfort" | "standby" | "economy" | "building_protection")[];
    /**
