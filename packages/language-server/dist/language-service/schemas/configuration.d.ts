 ...
 */
export interface ConfigurationRoot extends InternalIntegrations, CoreIntegrations, CustomIntegrations {
    /**
...
export interface InternalIntegrations {
     ...
     */
    alarm_control_panel?: integrations.Core.AlarmControlPanel.Schema | IncludeList;
    /**
